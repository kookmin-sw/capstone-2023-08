    ...
    return IntroductionScreen(
      ...
      pages: [
        PageViewModel(
          ...
          image: Image.asset('asset/img/musinsa.png',  fit: BoxFit.fitHeight, alignment: Alignment.center,),
          decoration: getPageDecoration(),
        ),
        PageViewModel(
          title: '갤러리 옷 입어보기',
          body: '자신의 휴대폰에 저장된 옷을 선택해주세요. \n이때, 배경이 없는 옷을 선택하면 더 나은 결과를 얻을 수 있습니다',
          image: Image.asset('asset/img/gallery.jpg', fit: BoxFit.fitHeight, alignment: Alignment.center,),
          decoration: getPageDecoration(),
        ),
        PageViewModel(
          title: '원하는 옷을 찜하기',
          body: '무신사 옷 중 마음에 드는 옷은 \n찜하기 버튼을 눌러 찜한 옷들을 확인할 수 있습니다',
          image: Center(child: Image.asset('asset/img/zzim.png', fit: BoxFit.fitHeight, alignment: Alignment.center,)),
          decoration: getPageDecoration(),
        ),
        PageViewModel(
          title: '촬영하고 시작하세요!',
          body: '착붙에서 가상피팅 서비스를 이용하기 위해 \n먼저 가이드라인에 따라 본인의 모습을 촬영해주세요',
          image: Image.asset('asset/img/camera.jpg', fit: BoxFit.fitHeight, alignment: Alignment.center,),
          decoration: getPageDecoration(),
        ),
      ],
